\chapter{Analysis of DVC in 66 kV HVAC Offshore Network}\label{3}
...
\section{Real Time Digital Simulator (RTDS) Hardware}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[height=8cm,width=8cm]{Diagrams/Chapter_3/Power_system_lib.PNG}
...
\centering
%\hspace*{-1cm}
    \includegraphics[height = 5.5cm,width = 17.5cm]{Diagrams/Chapter_3/WT1_AC_RSCAD.pdf}
...
The 700 MW offshore wind power is represented by a single \gls{OWF} consisting of 117 \gls{WG}s, each rated 6 MW connected in parallel. Type-4 \gls{WG}s are used for all units. The RSCAD representation of aggregated \gls{OWF} is used utilized in this work. The aggregated model consists of \gls{PE} components which require higher switching frequency (19*50 = 950 Hz in this case) and hence is modelled in a small-time step environment by selecting the "VSC Bridge Box" (Figure \ref{fig:SmallTimeStepBlock}) available in the small time step library in the Draft module. The box contains the \gls{PMSG}, \gls{MSC}, \gls{DC} capacitors, chopper circuit, \gls{GSC}, high pass filter and offshore transformer as illustrated in Figure \ref{fig:OveriewSmallTimeStepOWF}. As mentioned earlier in this section, the block can be assigned to have a time step value between 1400 to 3750 ns. 
...
\section{Implementation of DVC in GSC}\label{DVC_RSCAD}
...
%\centering
\hspace*{-2cm}
    \includegraphics[height = 6cm,width = 18.5cm]{Diagrams/Chapter_3/VACP_Freq_Final_2.eps}
...
%\centering
\hspace*{-0.1cm}
    \includegraphics[height = 6.5cm,width = 15.5cm]{Diagrams/Chapter_3/ID_IQ_Final_2.eps}
...
%\centering
\hspace*{-2cm}
    \includegraphics[height = 7.5cm,width = 20.5cm]{Diagrams/Chapter_3/ID_IQ_Washout_comp_2.eps}
    \caption{Active and reactive currents when active and reactive power loops washout filter proportional a) gain = 0.01, b) gain = 0.03 and c) gain = 0.05 }
