...
%\centering
\hspace*{-1.2cm}
\subfloat[Current in MMC-1 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_1_CB_5a.eps}%
\label{fig:IABC_MMC_1_CB_5a}}

\hspace*{-1.2cm}
\subfloat[Current in MMC-2 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_2_CB_5a.eps}%
...
\hspace*{-1.2cm}
\subfloat[Current in MMC-1 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_1_CB_6a.eps}%
\label{fig:IABC_MMC_1_CB_5a}}

\hspace*{-1.2cm}
\subfloat[Current in MMC-2 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_2_CB_6a.eps}%
\label{fig:IABC_MMC_2_CB_5a}}
...
\section{Energization of the HVAC cables and WGs}\label{energization_HVAC_Cables}
...
\hspace*{-1.2cm}
\subfloat[Current in MMC-1 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_1_Cab1charg.eps}%
\label{fig:IABC_MMC_1_Cab1charg}}

\hspace*{-1.2cm}
\subfloat[Current in MMC-2 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_2_Cab1charg.eps}%
...
\hspace*{-1.2cm}
\subfloat[Current in MMC-1 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_1_WT2off.eps}%
\label{fig:IABC_MMC_1_WT2off}}

\hspace*{-1.2cm}
\subfloat[Current in MMC-2 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_2_WT2off.eps}%
...
\hspace*{-1.2cm}
\subfloat[Current in MMC-1 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_1_3phaseSC.eps}%
\label{fig:IABC_MMC_1_3phaseSC}}

\hspace*{-1.2cm}
\subfloat[Current in MMC-2 bus]{%
  \includegraphics[height = 7cm,width = 18.5cm]{Diagrams/Chapter_5/IABC_MMC_2_3phaseSC.eps}%
